...
The Python programming language [@Python] and the following Python packages were used to perform the analysis: pandas [@pandas], altair [@altair], click [@click], 
...
Additionally, note that in @tbl-hoser-sd we consider the sample standard deviation of the number of horses during the same time span as Figure 1.
